...
def prune_population(poblacion, evaluaciones, poblacion_maxima):
        ...
        mejor_individuo_index = best_individual_index(evaluaciones, poblacion_maxima)
...
if mejor_individuo_index is not None:
    ...
    # Ajusta el cálculo del resultado según el tipo de problema
    resultado_mejor_individuo = evaluar_individuo(mejor_individuo, a, delta_x, tipo_problema)
    ...
    if tipo_problema == "max":
        print("{:<10} {:<25} {:<15} {:<15}".format(mejor_individuo_index, mejor_individuo, round(x_mejor, 6), resultado_mejor_individuo))
    else:
        print("{:<10} {:<25} {:<15} {:<15}".format(mejor_individuo_index, mejor_individuo, round(x_mejor, 6), -resultado_mejor_individuo))
else:
